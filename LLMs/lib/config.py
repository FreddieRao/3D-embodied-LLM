...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/data/home/raofu/data/SQA3D/LLMs" # TODO: change this

CONF.PATH.DATA = os.path.join(CONF.PATH.BASE, "data")
CONF.PATH.SCANNET = os.path.join(CONF.PATH.DATA, "scannet")
CONF.PATH.SCANREFER = os.path.join(CONF.PATH.DATA, "scanrefer")
...
# scannet
data_format = "filtered" #filtered
CONF.SCANREFER_TRAIN = os.path.join(CONF.PATH.SCANREFER, "ScanRefer_" + data_format + "_train.json")
CONF.SCANREFER_VAL = os.path.join(CONF.PATH.SCANREFER, "ScanRefer_" + data_format + "_val.json")
CONF.SCANREFER_TRAIN_LIST = os.path.join(CONF.PATH.SCANREFER, "ScanRefer_" + data_format + "_train.txt")
CONF.SCANREFER_VAL_LIST = os.path.join(CONF.PATH.SCANREFER, "ScanRefer_" + data_format + "_val.txt")
